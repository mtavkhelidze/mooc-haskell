...
allValues f (Node val l r) = f val && allValues f l && allValues f r
...
set (s : more) v (Node val l r) =
  case s of
    StepL -> Node val (set more v l) r
    StepR -> Node val l (set more v r)
